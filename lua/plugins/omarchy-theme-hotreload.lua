...
-- then symlink /home/jstitt/.config/omarchy/current/theme/neovim.lua in lua/config/omarchy-theme.lua
return {
  {
    ...
    config = function()
      ...
      vim.api.nvim_create_autocmd("User", {
        ...
        callback = function()
          ...
          package.loaded["config.omarchy-theme"] = nil

          vim.schedule(function()
            local ok, theme_spec = pcall(require, "config.omarchy-theme")
            if not ok then
              return
            end
